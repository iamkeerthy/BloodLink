...
<head>
    ...
    <style>
        ...
        .dropdown-menu , .dropdown-menu a:hover {
            background-color: #d22222; /* Change the color to match your navbar background */
        }
...
<body style="background-color: #f5f5dc;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top navbar-shading" style="background-color:#d22222;">
    <!-- <nav class="navbar navbar-expand-lg navbar-light" style="background-color:#FF0000;"> -->
    <a class="navbar-brand" href="../index.php" style="color:white;font-size:22px;letter-spacing:2px;">BloodLink</a>
